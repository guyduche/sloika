...
def from_events(ev, tag='scaled_', studentise=True, nanonet=False):
    ...
    :param studentise: Perform studentisation of features
    ...
    if studentise:
        features = untangled.maths.studentise(features, axis=0)
