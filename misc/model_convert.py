...
parser = argparse.ArgumentParser('Converts pickled sloika model between CPU and GPU (CUDA) versions. If you encounter problems please contact joe.harvey@nanoporetech.com')
